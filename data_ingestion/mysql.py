...
MYSQL_DATABASE = "NBAcharts"

# 創建元資料
metadata = MetaData()

# 各年度NBA球員薪資表
nba_players_salary_table = Table(
...
# 各年度NBA球員比賽數據
nba_players_state_table = Table(
    "nba_players_state",  # 資料表名稱
    metadata,
    Column("year", Integer, primary_key=True, comment="年度"),
    Column("player", String(100), primary_key=True, comment="球員名稱"),
    Column("team", String(50), nullable=False, comment="球隊名稱"),
    Column("age", Integer, nullable=False, comment="年齡"),
...
# 各年度NBA球隊基本表現數據
nba_teams_state_table = Table(
    "nba_teams_state",  # 資料表名稱
    metadata,
    Column("year", Integer, primary_key=True, comment="年度"),
...
# 各年度NBA球隊進階表現數據
nba_teams_advancedstate_table = Table(
    "nba_teams_advancedstate",  # 資料表名稱
    metadata,
    Column("year", Integer, primary_key=True, comment="年度"),
    Column("team", String(50), primary_key=True, comment="球隊名稱"),
...
# 各年度NBA球員資料整合表
nba_players_merge_table = Table(
    "nba_players_merge",  # 資料表名稱
    metadata,
    Column("year", Integer, primary_key=True, comment="年度"),
    Column("player", String(100), primary_key=True, comment="球員名稱"),    
    Column("team", String(100), primary_key=True, comment="球隊名稱"), 
    Column("salary", Integer, nullable=True, comment="薪水"),
...
# 各年度NBA球隊整合表
nba_teams_merge_table = Table(
    "nba_teams_merge",  # 資料表名稱
    metadata,
    Column("year", Integer, primary_key=True, comment="年度"),
    Column("team", String(50), primary_key=True, comment="球隊名稱"),
    Column("games", Integer, nullable=True, comment="參與比賽數"),
